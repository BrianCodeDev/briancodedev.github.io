...
document.getElementById("avatar-link").addEventListener("click", function(event) {
  ...
  // Show the progress bar at the top of the page below the fixed navbar
  progressContainer.style.display = "block";
  
  let progress = 0;
  
  // Increment the progress bar every 50 milliseconds for smooth animation
  ...
  setTimeout(() => {
    progressContainer.style.display = "none"; // Hide the bar
